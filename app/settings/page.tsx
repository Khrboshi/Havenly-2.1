export default function SettingsPage() {
  return (
    <div className="min-h-screen px-6 md:px-10 py-16 max-w-4xl mx-auto text-white">
      ...
      <p className="text-gray-400 mb-10">Feature coming soon.</p>
      ...
      <div className="space-y-6">
        ...
        <div className="p-6 rounded-xl border border-gray-700 bg-[#0F1A24]">
          ...
          <p className="text-gray-400 text-sm mt-2">
            Encrypted cloud storage for your journal entries is coming soon.
          </p>
        </div>
        ...
        <div className="p-6 rounded-xl border border-gray-700 bg-[#0F1A24]">
          ...
          <p className="text-gray-400 text-sm mt-2">
            Account deletion will be enabled when full authentication settings
            are implemented.
          </p>
        </div>
      </div>
