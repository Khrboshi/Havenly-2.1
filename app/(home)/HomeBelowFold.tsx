    ...
    <>
        ...
        <div className="mx-auto max-w-4xl px-5">
            ...
            <div className="overflow-hidden rounded-[1.75rem] border border-emerald-500/20 shadow-2xl shadow-black/50">
              ...
              <div className="flex items-center justify-between border-b border-emerald-500/15 bg-emerald-500/[0.08] px-6 py-4 sm:px-8">
                <div className="flex items-center gap-2.5">
                  ...
                  <p className="text-sm font-medium text-emerald-300">Your hidden pattern</p>
                </div>
              ...
              <div className="bg-[color:var(--hvn-bg-elevated)] px-6 py-7 sm:px-8 sm:py-8">
                <p className="font-display text-xl font-medium leading-relaxed text-white sm:text-2xl">
                  &ldquo;You often sound most overwhelmed when you feel responsible for{" "}
                  ...
                  <div className="flex flex-row gap-3 sm:flex-col sm:justify-center">
                    <div className="rounded-2xl border border-[color:var(--hvn-card-border)] bg-[color:var(--hvn-bg-soft)] px-4 py-3 text-center sm:px-5">
                      <p className="font-display text-2xl font-bold text-white sm:text-3xl">
                        14<span className="text-base font-normal text-slate-500">/22</span>
                      </p>
                    ...
                    <div className="rounded-2xl border border-[color:var(--hvn-card-border)] bg-[color:var(--hvn-bg-soft)] px-4 py-3 text-center sm:px-5">
                      <p className="font-display text-2xl font-bold text-white sm:text-3xl">
                        3<span className="text-base font-normal text-slate-500">wks</span>
                      </p>
                      <p className="mt-1 text-[11px] leading-snug text-slate-500">
          ...
          <ScrollReveal>
            <p className="mt-6 text-center text-sm text-slate-500">
              ...
              <Link href="/insights/preview" className="text-emerald-500 transition-colors hover:text-emerald-400">
                See a full example →
              </Link>
            </p>
          </ScrollReveal>
      ...
      <section className="border-b border-[color:var(--hvn-border-subtle)] section-tinted py-14 sm:py-20">
        <div className="mx-auto max-w-6xl px-5">
          <ScrollReveal className="mb-10 max-w-2xl">
            <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-emerald-500/70">What actually happens</p>
            <h2 className="mt-3 font-display text-2xl font-semibold text-white sm:text-3xl">
          ...
          <ScrollReveal className="overflow-hidden rounded-[1.5rem] border border-[color:var(--hvn-card-border)] md:grid md:grid-cols-2">
            <div className="border-b border-[color:var(--hvn-border-subtle)] bg-[color:var(--hvn-bg-elevated)] p-6 md:border-b-0 md:border-r">
              <div className="mb-4 flex items-center justify-between">
                <p className="text-[10px] font-semibold uppercase tracking-[0.2em] text-slate-600">What you write</p>
                <span className="rounded-full border border-[color:var(--hvn-card-border)] px-2 py-0.5 text-[10px] text-slate-600">~2 min</span>
              </div>
              <p className="text-[15px] leading-[1.75] text-slate-200">
                &ldquo;Work has been overwhelming. I keep saying yes and then resenting it. At home
                it&apos;s the same — I handle everything and feel guilty even thinking about stepping
                back.&rdquo;
              </p>
              <div className="mt-5 flex flex-wrap gap-1.5">
                {["Honest", "Unfiltered", "No structure needed"].map((t) => (
                  <span key={t} className="rounded-full border border-[color:var(--hvn-card-border)] px-2.5 py-0.5 text-[11px] text-slate-500">{t}</span>
                ))}
              </div>
            </div>
            <div className="border-t border-emerald-500/10 bg-emerald-950/30 p-6 md:border-t-0">
              ...
              <p className="text-[15px] leading-[1.75] text-slate-100">
                There&apos;s a pattern worth noticing: you&apos;re absorbing other people&apos;s needs
                to the point of exhaustion, then feeling guilty for wanting relief. That guilt isn&apos;t
                proof you&apos;re asking for too much.
              </p>
          ...
          <ScrollReveal stagger className="mt-6 grid gap-3 sm:grid-cols-3 sm:gap-4">
            {[
              { step: "1", label: "Write the version that is actually true", sub: "One honest sentence is enough to begin.", accent: "text-emerald-400", border: "border-emerald-500/20" },
              { step: "2", label: "Get a reflection that names what you feel", sub: "Not advice. A mirror. Short, thoughtful, honest.", accent: "text-violet-400", border: "border-violet-500/20" },
              { step: "3", label: "See what keeps returning over time", sub: "Patterns across weeks and months, not just today.", accent: "text-amber-400", border: "border-amber-500/20" },
            ].map(({ step, label, sub, accent, border }) => (
              <div key={step} className={`rounded-2xl border bg-[color:var(--hvn-bg-elevated)] p-5 ${border}`}>
                <p className={`mb-2 text-xs font-semibold uppercase tracking-[0.2em] ${accent}`}>Step {step}</p>
                <p className="text-[15px] font-medium leading-snug text-white">{label}</p>
          ...
          <div className="mt-8 text-center">
            <Link href="/magic-login" className="inline-flex items-center justify-center rounded-full bg-emerald-500 px-6 py-3.5 text-sm font-semibold text-slate-950 shadow shadow-emerald-500/20 transition-all hover:bg-emerald-400 hover:-translate-y-px">
        ...
        <div className="mx-auto max-w-6xl px-5">
          ...
          <ScrollReveal stagger className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div className="rounded-[1.5rem] border border-violet-500/20 bg-violet-500/[0.04] p-6">
              ...
              <p className="mt-3 text-lg font-semibold leading-snug text-white sm:text-xl">Emotional load appears in <span className="text-violet-300">14 of your last 22</span> entries.</p>
              <div className="mt-4 space-y-2">
                {[{ label: "Emotional load", pct: 64, color: "bg-violet-400" }, { label: "Overwhelm", pct: 45, color: "bg-violet-500/60" }, { label: "Clarity", pct: 28, color: "bg-violet-600/50" }].map(({ label, pct, color }) => (
                  <div key={label}>
                    <div className="mb-1 flex items-center justify-between"><span className="text-xs text-slate-500">{label}</span><span className="text-xs text-slate-600">{pct}%</span></div>
                    <div className="h-1.5 w-full rounded-full bg-[color:var(--hvn-bg-soft)]"><div className={`h-1.5 rounded-full ${color}`} style={{ width: `${pct}%` }} /></div>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="rounded-[1.5rem] border border-emerald-500/20 bg-emerald-500/[0.04] p-6">
              ...
              <p className="mt-3 text-lg font-semibold leading-snug text-white sm:text-xl">Responsibility and communication are the <span className="text-emerald-300">two themes most often linked</span> together.</p>
              <div className="mt-4 grid grid-cols-2 gap-2">
                {[
                  ...
                  { label: "Boundary-setting", count: "7×", color: "border-[color:var(--hvn-card-border)] bg-[color:var(--hvn-bg-soft)] text-slate-400" },
                  { label: "Exhaustion", count: "6×", color: "border-[color:var(--hvn-card-border)] bg-[color:var(--hvn-bg-soft)] text-slate-400" },
            ...
            <div className="relative rounded-[1.5rem] border border-amber-500/20 bg-amber-500/[0.04] p-6 sm:col-span-2 lg:col-span-1">
              <div className="flex items-start justify-between gap-3">
                ...
                <span className="shrink-0 rounded-full border border-amber-500/20 bg-amber-500/10 px-2 py-0.5 text-[9px] font-semibold uppercase tracking-[0.15em] text-amber-400">Premium</span>
              </div>
              <p className="mt-3 text-[15px] leading-[1.7] text-slate-200">You often sound most overwhelmed when you feel responsible for <span className="text-amber-300">keeping everything steady for everyone else</span> — and rarely give yourself the same patience.</p>
            ...
            <div className="relative rounded-[1.5rem] border border-rose-500/20 bg-rose-500/[0.04] p-6">
              <div className="flex items-start justify-between gap-3">
                ...
                <span className="shrink-0 rounded-full border border-rose-500/20 bg-rose-500/10 px-2 py-0.5 text-[9px] font-semibold uppercase tracking-[0.15em] text-rose-400">Premium</span>
              </div>
              <p className="mt-3 text-[15px] leading-[1.7] text-slate-200">This week, your entries returned most often to questions of worth, pace, and <span className="text-rose-300">what you&apos;re actually allowed to need</span>.</p>
            ...
            <div className="rounded-[1.5rem] border border-slate-500/20 bg-slate-500/[0.04] p-6">
              ...
              <p className="mt-3 text-lg font-medium leading-snug text-white sm:text-xl">&ldquo;What keeps making you say you&apos;re fine before you&apos;ve had a chance to ask whether you are?&rdquo;</p>
              <p className="mt-3 text-xs text-slate-600">Generated from your last 6 entries. Not a prompt to answer — just something to carry.</p>
            </div>
          </ScrollReveal>

          <ScrollReveal className="mt-8 text-center">
            <Link href="/insights/preview" className="inline-flex items-center justify-center gap-2 text-sm font-medium text-emerald-400 transition-colors hover:text-emerald-300">See a fuller example of Premium insights →</Link>
          </ScrollReveal>
        </div>
      </section>
      ...
      <section className="border-b border-[color:var(--hvn-border-subtle)] py-12 sm:py-16">
        <div className="mx-auto max-w-5xl px-5">
          ...
          <div className="mt-10 grid gap-5 lg:grid-cols-3 lg:items-stretch">
            {[
              {
                wrote: "I keep saying yes to things even when I'm already overwhelmed. I stayed up until 2am finishing something that probably could have waited, but I felt guilty leaving it.",
                reflected: "Work has been piling up and you keep saying yes even when you're already overwhelmed — the guilt of stopping feels heavier than the cost of continuing.",
                tags: ["exhaustion", "guilt", "overcommitment"],
              },
              {
                wrote: "A conversation with a close friend has been sitting with me. I feel like I said the wrong thing and now there's this weird distance between us that neither of us is addressing.",
                reflected: "The distance you felt — and what you didn't say — is still there. Replaying the conversation is your mind trying to find the version where you got it right.",
                tags: ["longing", "disconnection", "hurt"],
              },
              {
                wrote: "I've been snapping at people I care about and I don't fully understand why. I'm not angry at them. I think I'm just running on empty.",
                reflected: "You're running on empty and everything feels like one more thing — the snapping isn't anger, it's what happens when there's nothing left to absorb with.",
          ...
          <ScrollReveal className="mt-8 text-center">
            <Link href="/magic-login" className="inline-flex items-center justify-center rounded-full bg-emerald-500 px-6 py-3 text-sm font-semibold text-slate-950 shadow-lg shadow-emerald-500/20 transition-all hover:bg-emerald-400 hover:-translate-y-px">Write your first entry free →</Link>
      ...
      <section className="border-b border-[color:var(--hvn-border-subtle)] py-12 sm:py-16">
        <div className="mx-auto max-w-4xl px-5">
          <ScrollReveal className="text-center">
            <p className="text-[11px] font-medium uppercase tracking-[0.2em] text-emerald-500/60">Built with care</p>
            <h2 className="mt-3 font-display text-2xl font-semibold text-white sm:text-3xl">
            ...
            {[
              {
                ...
                // Static copy — not trial-dependent
      ...
      <div className="border-y border-[color:var(--hvn-border-subtle)] py-12 sm:py-14">
        <ScrollReveal className="mx-auto max-w-4xl px-5 text-center">
          <p className="font-display text-2xl font-medium leading-relaxed text-white sm:text-3xl sm:leading-relaxed">
            ...
            <span className="text-slate-500">They&apos;re just too close to their own life to see the pattern clearly.</span>
          </p>
        </ScrollReveal>
      </div>
        ...
        <div className="mx-auto max-w-6xl px-5">
          ...
          <ScrollReveal stagger className="flex flex-col-reverse gap-4 md:grid md:grid-cols-2 md:gap-5">
            <div className="flex flex-col rounded-2xl border border-[color:var(--hvn-card-border)] bg-[color:var(--hvn-bg-elevated)] p-5 sm:p-6">
              ...
              <p className="mt-1 font-display text-xl font-semibold text-white sm:text-2xl">A private place to start</p>
              <div className="mt-2 flex items-baseline gap-1.5"><span className="text-3xl font-bold text-white">$0</span><span className="text-sm text-slate-400">/ month</span></div>
              <p className="mt-3 text-sm text-slate-500">A calm place to write honestly, with no commitment, no pressure, and no audience.</p>
              <ul className="mt-5 space-y-3 text-sm text-slate-300">
                {[
                  ...
                  <li key={label} className="flex items-start gap-2"><span className="mt-0.5 shrink-0 text-emerald-600">✓</span><div><p>{label}</p><p className="text-xs text-slate-500">{sub}</p></div></li>
                ))}
              </ul>
              <div className="mt-auto pt-6">
                <Link href="/magic-login" className="inline-flex w-full items-center justify-center rounded-full border border-[color:var(--hvn-card-border)] bg-[color:var(--hvn-bg-elevated)] px-5 py-3 text-sm font-medium text-[color:var(--hvn-text-secondary)] transition-colors hover:bg-[color:var(--hvn-bg-soft)]">Start free</Link>
                <p className="mt-2 text-center text-xs text-slate-700">No card required. No expiry.</p>
              </div>
            </div>
            ...
            <div className="relative flex flex-col rounded-2xl border border-emerald-500/25 bg-emerald-500/[0.04] p-5 sm:p-6">
              ...
              <p className="mt-1 font-display text-xl font-semibold text-white sm:text-2xl">The full pattern, not just the latest entry</p>
              <div className="mt-2 flex flex-wrap items-baseline gap-x-2 gap-y-1">
                <span className="text-3xl font-bold text-white">{PRICING.monthly}</span>
                <span className="text-sm text-slate-400">/ month</span>
                <span className="rounded-full border border-emerald-500/20 bg-emerald-500/10 px-2.5 py-0.5 text-[11px] font-medium text-emerald-400">{PRICING.valueLabel}</span>
              </div>
              ...
              <ul className="mt-5 space-y-3 text-sm text-slate-200">
                {[
                  ...
                  <li key={label} className="flex items-start gap-2"><span className="mt-0.5 shrink-0 text-emerald-400">✓</span><div><p>{label}</p><p className="text-xs text-slate-500">{sub}</p></div></li>
                ))}
              </ul>
              <div className="mt-auto flex flex-col gap-2 pt-6">
                <Link href="/upgrade" className="inline-flex w-full items-center justify-center rounded-full bg-emerald-500 px-5 py-3 text-sm font-semibold text-slate-950 shadow-lg shadow-emerald-500/20 transition-all hover:bg-emerald-400 hover:-translate-y-px">Start seeing the pattern →</Link>
                ...
                <div className="rounded-xl border border-emerald-500/15 bg-emerald-500/[0.04] px-4 py-2.5 text-center">
                  <p className="text-xs font-medium text-slate-300">🛡️ {PRICING.trialLabel} — no charge today</p>
                  <p className="mt-0.5 text-[11px] leading-relaxed text-slate-600">
                    {PRICING.trialFreeFor} · then {PRICING.monthlyCadence} · Cancel anytime
                  </p>
                </div>
                <Link href="/insights/preview" className="inline-flex w-full items-center justify-center rounded-full border border-[color:var(--hvn-card-border)] px-5 py-2.5 text-xs font-medium text-[color:var(--hvn-text-secondary)] transition-colors hover:bg-[color:var(--hvn-bg-soft)]">Preview Premium insights</Link>
              </div>
              <p className="mt-3 text-center text-xs text-slate-700">{PAYMENT.checkoutTrustLine}</p>
            </div>
          </ScrollReveal>
        </div>
      </section>
      ...
      <section className="bg-[color:var(--hvn-bg)] py-12 sm:py-14">
        <div className="mx-auto max-w-3xl px-5">
          <ScrollReveal>
            <h2 className="font-display text-xl font-semibold text-white sm:text-2xl">A few honest answers</h2>
          </ScrollReveal>
          ...
          <div className="mt-8 text-xs text-slate-700">
            <Link href="/privacy" className="text-emerald-600 transition-colors hover:text-emerald-500">Read the Privacy Policy &rarr;</Link>
          </div>
        </div>
      </section>
      ...
      <section className="relative overflow-hidden border-t border-[color:var(--hvn-border-subtle)] section-cta-gradient py-20 sm:py-28">
        ...
        <div className="relative mx-auto max-w-3xl px-5 text-center">
          <ScrollReveal>
            <p className="mb-4 text-[11px] font-medium uppercase tracking-[0.2em] text-emerald-500/60">Ready when you are</p>
            ...
            <p className="mx-auto mt-4 max-w-md text-[15px] leading-relaxed text-slate-400">
              You don&apos;t need to have it figured out to begin. One honest sentence is enough.
            </p>
            <div className="mt-8 flex flex-col items-stretch gap-3 sm:flex-row sm:items-center sm:justify-center">
              <Link href="/magic-login" className="inline-flex items-center justify-center rounded-full bg-emerald-500 px-8 py-4 text-base font-semibold text-slate-950 shadow-xl shadow-emerald-500/25 transition-all hover:bg-emerald-400 hover:-translate-y-0.5">
                Write your first entry free →
              </Link>
            </div>
