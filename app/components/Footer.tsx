    ...
    <div className="flex flex-wrap gap-x-10 gap-y-6 text-xs text-slate-500">
      ...
      <div className="space-y-2.5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Link href="/upgrade" className="transition-colors hover:text-slate-300">Pricing</Link>
          <Link href="/blog" className="transition-colors hover:text-slate-300">Blog</Link>
          <Link href="/install" className="transition-colors hover:text-slate-300">Install app</Link>
        </div>
      </div>
      ...
      <div className="space-y-2.5">
        ...
        <div className="flex flex-col gap-2">
          {isSignedIn ? (
            <>
              <Link href="/dashboard" className="transition-colors hover:text-slate-300">Dashboard</Link>
              <Link href="/tools" className="transition-colors hover:text-slate-300">Tools</Link>
              <Link href="/settings" className="transition-colors hover:text-slate-300">Settings</Link>
              <Link href="/settings/billing" className="transition-colors hover:text-slate-300">Billing</Link>
            </>
          ) : (
            <>
              <Link href="/magic-login" className="transition-colors hover:text-slate-300">Sign in</Link>
              <Link href="/magic-login" className="transition-colors hover:text-slate-300">Start free</Link>
              <Link href="/upgrade" className="transition-colors hover:text-slate-300">Go Premium</Link>
            </>
          )}
        </div>
      </div>
        ...
        <div className="flex flex-col gap-8 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="max-w-xs space-y-3">
            ...
            <p className="text-xs leading-relaxed text-slate-500">
              The only journal that reads back.
            </p>
