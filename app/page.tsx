...
// Havenly Landing – Soft Blue Calm v3.0
// - High-conversion free → premium flow
// - Max clarity and emotional resonance
// - Zero external dependencies; drop-in safe
// - Designed for performance + engagement
...
export default function HomePage() {
  return (
    <main className="min-h-screen w-full bg-[#050816] text-slate-100">
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="max-w-xl space-y-6">
            ...
            <p className="text-sm leading-relaxed text-slate-300 sm:text-base">
              ...
              No streaks, no pressure, no performance. Just a private place to
              understand what you feel, why it’s there, and how it shifts over
              time. Start free. Upgrade only if deeper guidance truly serves you.
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Link
                href="/upgrade"
                className="rounded-full border border-slate-600 px-6 py-3 text-sm font-medium text-slate-100 transition hover:bg-slate-800/60"
              >
                See Premium options
              </Link>
            </div>
            ...
            <p className="text-xs text-slate-400">
              Free plan requires no card. Your space stays private even if you never upgrade.
            </p>
      ...
      {/* ================= WHO IT’S FOR ================= */}
      <section className="border-t border-slate-800/70 px-6 pb-16 pt-14 md:px-10 lg:px-24 bg-[#050816]">
        <div className="mx-auto max-w-5xl space-y-10">
          ...
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-sm text-slate-300 sm:text-base">
              ...
              emotionally overloaded, or struggle to make space for their own needs.
            </p>
          </div>
            ...
            {[
              {
                ...
                text: "A place to put what you're holding without worrying about how it sounds or should be ‘fixed’.",
              },
              {
      ...
      {/* ================= HOW IT WORKS ================= */}
      <section className="border-t border-slate-800/70 px-6 pb-20 pt-14 md:px-10 lg:px-24 bg-[#050816]">
        <div className="mx-auto max-w-5xl space-y-10">
          ...
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-sm text-slate-300 sm:text-base">
              No streaks. No gamification. Just a simple ritual you can return to.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                text: "Premium members see deeper themes across weeks & months.",
              },
            ].map((item) => (
              <div
                key={item.step}
      ...
      {/* ================= FREE vs PREMIUM ================= */}
      <section className="border-t border-slate-800/70 px-6 pb-28 pt-14 md:px-10 lg:px-24 bg-[#050816]">
        <div className="mx-auto max-w-5xl space-y-12">
          ...
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-sm text-slate-300 sm:text-base">
              Stay on Free as long as you need. Upgrade for deeper guidance and
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="flex flex-col rounded-2xl border border-slate-800 bg-[#050816] p-7 shadow-[0_18px_45px_rgba(0,0,0,0.6)]">
              ...
              <p className="mt-2 text-sm text-slate-300">
                A steady, private outlet without pressure to pay or perform.
              </p>
            ...
            <div className="relative flex flex-col rounded-2xl border border-emerald-400/70 bg-[#050816] p-7 shadow-[0_25px_65px_rgba(0,0,0,0.75)]">
              ...
              <ul className="mt-4 space-y-2 text-sm text-slate-300">
                ...
                <li>Deeper reflections that challenge unhelpful stories</li>
                <li>Early access to supportive tools & journeys</li>
              </ul>
      ...
      {/* ================= FINAL CTA ================= */}
      <section className="border-t border-slate-800/70 px-6 pb-24 pt-12 md:px-10 lg:px-24 bg-[#050816]">
        <div className="mx-auto max-w-xl space-y-5 text-center">
          ...
          <p className="text-sm text-slate-300 sm:text-base">
            Havenly offers a simple ritual: a few quiet minutes to notice what
            you're carrying, and a gentle reflection to help you make sense of
            it in a kinder way.
          </p>
          ...
          <div className="mt-4 flex flex-wrap justify-center gap-3">
            ...
            <Link
              href="/upgrade"
              className="rounded-full border border-slate-600 px-6 py-3 text-sm font-medium text-slate-100 hover:bg-slate-800/60"
            >
              Learn about Premium
            </Link>
          </div>
