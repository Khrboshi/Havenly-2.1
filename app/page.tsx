// app/page.tsx
// Havenly Landing – Soft Blue Calm, conversion-focused
// - Clear free vs premium story
// - Gentle, psychological tone (not “productivity app”)
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="max-w-xl space-y-6">
            ...
            <p className="text-sm leading-relaxed text-slate-300 sm:text-base">
              Havenly is a quiet journaling space with gentle AI reflections. It
              doesn’t judge, chase streaks, or push you to “optimize”. It simply
              helps you notice what you feel, why it’s there, and how it shifts
              over time. Start free. Upgrade only if deeper guidance truly
              serves you.
            </p>

            <div className="flex flex-wrap gap-3">
              {/* Primary CTA – Free check-in */}
              <Link
                href="/magic-login"
            ...
            <div className="rounded-2xl border border-slate-700/70 bg-[#050816]/90 p-6 shadow-[0_30px_80px_rgba(0,0,0,0.65)]">
              ...
              <div className="mb-6 rounded-xl border border-slate-700/70 bg-slate-900/80 p-4">
                ...
                <p className="mt-2 text-sm leading-relaxed text-slate-200">
                  ...
                  to choose just one thing to care about tonight, rather than
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              },
              {
                ...
                text: "You receive a gentle reflection. On Premium, Havenly also highlights emotional themes across weeks and months.",
              },
            ].map((item) => (
              <div
                key={item.step}
        ...
        <div className="mx-auto max-w-5xl space-y-10">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="relative flex flex-col rounded-2xl border border-emerald-400/70 bg-[#050816] p-7 shadow-[0_25px_65px_rgba(0,0,0,0.75)]">
              ...
              <p className="mt-2 text-sm text-slate-300">
                For deeper emotional themes and long-term patterns. Premium
                helps you understand not just how you feel today, but how your
                inner world has been shifting over time.
              </p>
              <ul className="mt-4 space-y-2 text-sm text-slate-300">
      ...
      <section className="border-t border-slate-800/70 bg-[#050816] px-6 pb-24 pt-12 md:px-10 lg:px-24">
        <div className="mx-auto max-w-xl space-y-5 text-center">
          ...
          <p className="text-sm text-slate-300 sm:text-base">
            Havenly offers a small, repeatable ritual: a few honest minutes to
            notice what you’re carrying, and a gentle reflection to help you
            make sense of it in a gentler way.
          </p>
