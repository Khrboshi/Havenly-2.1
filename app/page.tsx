// app/page.tsx
// Havenly Landing – Soft Blue Calm, conversion-focused v2.1 Final
        ...
        <div className="mx-auto flex max-w-6xl flex-col gap-10 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="max-w-xl space-y-6">
            ...
            <p className="text-sm leading-relaxed text-slate-300 sm:text-base">
              ...
              It simply helps you notice what you feel, why it’s there,
              and how it shifts over time. Start free. Upgrade only if
              deeper guidance truly serves you.
            </p>
        ...
        <div className="mx-auto max-w-5xl space-y-10">
          ...
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-sm text-slate-300 sm:text-base">
              Havenly supports people who replay conversations at night,
              feel emotionally overloaded, or struggle to make space for
              their own needs while caring about everyone else.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              >
                <h3 className="text-sm font-semibold text-slate-50">{i.title}</h3>
                <p className="mt-2 text-xs leading-relaxed text-slate-300">{i.text}</p>
              </div>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-5xl space-y-10">
          ...
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-sm text-slate-300 sm:text-base">
              ...
              deeper understanding and a clearer sense of the story behind your days.
            </p>
          </div>
      ...
      <section className="border-t border-slate-800/70 bg-[#050816] px-6 pb-24 pt-12 md:px-10 lg:px-24">
        <div className="mx-auto max-w-xl space-y-5 text-center">
          ...
          <p className="text-sm text-slate-300 sm:text-base">
            ...
            you make sense of it in a kinder way.
          </p>
