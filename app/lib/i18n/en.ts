...
export const en: Translations = {
  ...
  upgradeFull: {
    ...
    faq4Q:                "What if I do not write very often?",
    faq4A:                "Premium can still be worthwhile. Patterns typically begin emerging after five to seven entries \u2014 most people see their first insight within two weeks of starting. The weekly summary reflects whatever you have written, even if it was a lighter week. There is no minimum to benefit.",
    faq5Q:                "Will I be charged automatically every month?",
