...
export const en: Translations = {
  ...
  journal: {
    ...
    privacyReminder:     "Your journal is private. No one else can read what you write. Entries are not used to train AI models.",
  ...
  reflection: {
    ...
    savedPermanently:      "Saved to your history · Quiet Mirror uses this to build your pattern history",
    ...
    crisisPrivacy:         "Your entries are private · You don’t have to figure this out alone",
  },
  ...
  dashboard: {
    ...
    welcomePrivacy:             "Takes less than a minute · stays private · does not train AI",
  ...
  footer: {
    ...
    account:           "Account",
    legal:             "Legal",
    serviceGuarantees: "Our commitments",
    about:             "About",
    pricing:           "Pricing",
    blog:              "Blog",
    ...
    privacyAssurance:  MARKETING.privacyTrustLine,
  ...
  settingsPage: {
    ...
    dataPrivacySubtitle:  "Your entries belong to you.",
  ...
  upgradeTrigger: {
    ...
    cancelAnytime:        "Cancel anytime",
    terms:                "Terms",
    reflectionIntro:      "When you\u2019re ready, Quiet Mirror will reflect back what it noticed \u2014 themes, emotions, and a gentle next step. Each entry gets one reflection, saved to your history so your patterns stay accurate over time.",
    seeExample:           "See an example",
  ...
  homeBelowFold: {
    ...
    cardATitle:MARKETING.insightTag1,cardAHead:"Emotional load appears in 14 of your last 22 entries.",
    cardABar1:"Emotional load",cardABar2:"Overwhelm",cardABar3:"Clarity",cardABar4:"",
    cardBTitle:MARKETING.insightTag2,cardBHead:"Responsibility and communication are the two themes most often linked together.",
    cardBT1:"Responsibility",cardBT2:"Communication",cardBT3:"Boundary-setting",cardBT4:"Exhaustion",cardBPer:"this month",
    cardCTitle:MARKETING.insightTag3,cardCHead:"You often sound most overwhelmed when you feel responsible for keeping everything steady for everyone else — and rarely give yourself the same patience.",cardCNote:"This pattern appeared in your last 3 weeks of entries. It tends to peak on Sundays.",
    cardDTitle:MARKETING.insightTag4,cardDHead:"Curiosity and honesty are rising in recent entries — which often signals that something important is becoming clearer.",cardDNote:"Clarity signal up over the last 2 weeks",
    cardETitle:MARKETING.insightTag5,cardEHead:"This week, your entries returned most often to questions of worth, pace, and what you're actually allowed to need.",cardENote:"Generated every Monday · Personal to your entries only",
    cardFTitle:MARKETING.insightTag6,cardFHead:"\"What keeps making you say you're fine before you've had a chance to ask whether you are?\"",cardFNote:"Generated from your last 6 entries. Not a prompt to answer — just something to carry.",
    ...
    trust1Title:"Private by design",trust1Body:"Your entries are not used to train AI models, not sold, and not seen by anyone but you. Privacy is the foundation this product is built on.",
    ...
    freeF4Label:"Encrypted & private",freeF4Sub:"Your entries are not shared, sold, or used to train AI",
    ...
    faq2Q:"Is this therapy?",faq2A:"No. Quiet Mirror is a private journaling companion. It can sit alongside therapy or personal reflection, but it is not clinical care and it does not replace professional support. If you are going through something acute, please reach out to a mental health professional or a crisis line in your country.",
    faq3Q:"Do I need to write every day for it to work?",faq3A:"No. Some people write several times a week. Others only when life feels heavy. Patterns typically start appearing after five to seven entries \u2014 most people see their first insight within two weeks. The more you write, the more Quiet Mirror has to notice \u2014 but there is no streak to maintain.",
    faq4Q:"What happens to my entries?",faq4A:"They stay private. They are not used to train AI models, not sold, and not shared. Quiet Mirror is built around the idea that your inner life belongs to you.",
    faq5Q:"Why would someone pay for Premium?",faq5A:(n)=>`Free gives you a private place to write and ${n} AI reflections per month \u2014 enough to feel how it works. Premium is for when you want Quiet Mirror to read across your entries over time and show you what keeps repeating. Most people start noticing patterns within two weeks of regular writing. It\u2019s the difference between documenting what happened and understanding why it keeps happening.`,
  ...
  requirePremium: {
    ...
    trustLine:             MARKETING.privacyTrustLine,
  },
  magicLoginPage: {
    ...
    feat1:"Write privately — your entries are not shared or sold",
  ...
  upgradePage: {
    ...
    faq4A:"Even two entries can surface something. Patterns begin to appear quickly — and the weekly summary reflects whatever you have written, even if it was a lighter week.",
    ...
    compRow1:"Journal entries",compRow2:"Pattern insights",compRow3:"Weekly summary",
    compRow4:"Why-it-keeps-happening",compRow5:"AI reflections",compRow6:"Private & ad-free",
  ...
  email: {
    ...
    footerLine2:       "Your email address is not sold or shared.",
    privacyPolicy:     "Privacy Policy",
  ...
  insightPreview: {
    ...
    patternNoDataAfter:   "Even 2 entries can surface something.",
  ...
  aboutPage: {
    ...
    card2Body:     "Revenue comes from Premium subscriptions. Your data is not sold, shared, or used to train AI models. No ads — that is how the product is built to work.",
    ...
    privacyTag:    "Privacy",
    privacy1:      "Your journal is private. Your entries are not used to train AI models, not shared with third parties, and not shown to anyone but you.",
  ...
  upgradeFull: {
    ...
    proofBar1:            MARKETING.proofBar1,
    proofBar2:            MARKETING.proofBar2,
    proofBar3:            MARKETING.proofBar3,
    proofBar4:            MARKETING.proofBar4,
    proofStat1:           MARKETING.proofStat1,
    proofStat2:           MARKETING.proofStat2,
    proofReflects:        "reflects",
    proofQuote:           MARKETING.proofQuote,
    proofNote:            "This pattern appeared in your last 3 weeks of entries. It tends to peak on Sundays.",
    proofPrivacy:         "Only you can see this. Not shared, not used to train AI.",
    perMonth:             "/ month",
    trialNoCharge:        "no charge today",
    trialExplainer:       (trialLabel) => `Try everything during your ${trialLabel}. Cancel before then and you won\u2019t be charged. To cancel, go to Settings \u2014 it takes seconds.`,
    ...
    card5Tag:             MARKETING.insightTag5,
    ...
    card6Tag:             MARKETING.insightTag6,
    ...
    faq4Q:                "What if I do not write very often?",
    faq4A:                "Even two or three entries can surface something. Patterns typically begin emerging after five to seven entries \u2014 most people see their first insight within two weeks of starting. The weekly summary reflects whatever you have written, even if it was a lighter week. There is no minimum to benefit.",
    faq5Q:                "Will I be charged automatically every month?",
    ...
    // Emotional progression timeline — shows what changes over time
    ...
    // Founder trust strip — accountability as social proof
  ...
  legalPages: {
    ...
    privacyMetaDescription: (appName) => `Learn how ${appName} collects, uses, and protects your data. Your journal entries are private and not used to train AI models.`,
    privacyOgTitle:         (appName) => `Privacy Policy | ${appName}`,
    privacyOgDescription:   (appName) => `Learn how ${appName} protects your privacy. Your journal entries are not sold or used to train AI models.`,
