...
export const ar: Translations = {
  ...
  upgradeFull: {
    ...
    pF3Sub: "مرآة مكتوبة لما لاحظه Quiet Mirror هذا الأسبوع",
    ...
    card4Tag: "ما يتحول",
    card4Text: "الفضول والصدق في ارتفاع في المدخلات الأخيرة — مما يشير غالبًا إلى أن شيئًا مهمًا يصبح أوضح.",
