...
export const ar: Translations = {
  ...
  reflection: {
    ...
    scriptLine:            "نص داخلي",
    savedPermanently:      "محفوظ في سجلك · يستخدم Quiet Mirror هذا لبناء سجل أنماطك",
  ...
  dashboard: {
    ...
    writingDaysLabel: (n) => `${n} ${n === 1 ? "يوم كتابة" : "أيام كتابة"}`,
  ...
  settingsPage: {
    ...
    dataPrivacySubtitle:  "مدخلاتك ملكك.",
  ...
  homepage: {
    metaTitle:        (appName) => `${appName} — اليوميات التي تقرأ ما تحتها`,
    metaDescription:  "اكتب ما يُثقل عليك. تلقَّ تأملاً لطيفاً في المقابل. ابدأ برؤية الأنماط التي كنت قريباً منها لدرجة أنك لم تسمّها. مجاني للبدء، بدون بطاقة ائتمان.",
    ogTitle:          (appName) => `${appName} — اليوميات التي تقرأ ما تحتها`,
    ogDescription:    "اكتب بصدق. تلقَّ تأملاً لطيفاً في المقابل. شاهد الأنماط التي تشكّل حياتك.",
    ...
    heroPriceHint:    (price: string, trialDays: number) => `مجانًا للبدء · ${price} في الشهر إذا كنت تريد الصورة الأعمق · ${trialDays} أيام تجربة مجانية متضمنة`,
    ...
    trust4:           "بدون إعلانات — مدعوم بالاشتراكات",
  ...
  homeBelowFold: {
    ...
    ex2T1:"ازدواجية",ex2T2:"انفصال",ex2T3:"قيمة",
    ...
    trust1Title:"خاص بالتصميم",trust1Body:"مدخلاتك لا تُستخدم أبداً لتدريب نماذج الذكاء الاصطناعي، ولا تُباع، ولا يراها أحد سواك. الخصوصية هي الأساس الذي بُني عليه هذا المنتج.",
    trust3Title:"مدعوم بالاشتراكات",trust3Body:"يحقق Quiet Mirror إيرادات من اشتراكات Premium. هذا هو النموذج الحالي — مصمم حتى لا تكون بياناتك المنتج.",
    ...
    ctaT1:"خاص بشكل افتراضي",ctaT2:"لا يدرّب الذكاء الاصطناعي أبداً",ctaT4:"بدون إعلانات — مدعوم بالاشتراكات",
  },
  moodTool: {
  ...
  requirePremium: {
    ...
    headingPrimary:        "لقد كنت تكتب بصدق.",
    headingAccent:         "من هنا تبدأ الصورة الأعمق.",
    body:                  "هذه الميزة جزء من Premium — الطبقة التي تقرأ عبر مدخلاتك مع مرور الوقت وتُظهر لك ما يتكرر، وما يتغير، وما قد يكون كامنًا تحته.",
    premiumFeatureBadge:   "✦ ميزة Premium",
    perMonthSuffix:        "/ شهريًا",
    previewCta:            "معاينة ما يُظهره Premium",
    continueFreeCta:       "→ متابعة التدوين مجانًا",
    trustLine:             "مدخلاتك خاصة، ولا تُشارَك أبدًا، ولا تُستخدم لتدريب نماذج الذكاء الاصطناعي.",
  },
  magicLoginPage: {
  ...
  upgradePage: {
    ...
    faq1Q:(appName)=>`ما الذي يُظهره لي ${appName} فعلاً مع Premium؟`,
  ...
  insightPreview: {
    ...
    demoParagraph1:       "أنت غالبًا ما تكتب عن العمل والمسيرة المهنية، والعلاقات، والتأملات الحياتية العامة، مع إحساس بالقلق يغلي تحت السطح. مدخلاتك مليئة بلحظات الجهد والراحة، لكن ضغط الأداء رفيق دائم.",
  ...
  // ── aboutPage ──────────────────────────────────────────────────────────
  aboutPage: {
    metaTitle: (appName) => `عن ${appName} — اليوميات التي تقرأ ما تحتها`,
    metaDescription: 'دفتر يوميات خاص يعكس ما تكتبه — ومع الوقت، يُظهر لك الأنماط التي كنت قريبًا منها لدرجة أنك لم ترها. مبني باستقلالية، بلا إعلانات، بلا مستثمرين.',
    ogTitle: (appName) => `عن ${appName} — اليوميات التي تقرأ ما تحتها`,
    ogDescription: 'دفتر يوميات خاص يعكس ما تكتبه — ومع الوقت، يُظهر لك الأنماط التي كنت قريبًا منها لدرجة أنك لم ترها.',
    ...
    card2Label: 'مدعوم بالاشتراكات',
    card2Body: 'تأتي الإيرادات من اشتراكات Premium. بياناتك لا تُباع أبدًا ولا تُشارك ولا تُستخدم لتدريب نماذج الذكاء الاصطناعي. بدون إعلانات — هكذا بُني المنتج.',
  ...
  upgradeFull: {
    ...
    faq1Q: (appName) => `ماذا يُظهر لي ${appName} فعلاً مع Premium؟`,
  ...
  // ── blogPage ────────────────────────────────────────────────
  blogPage: {
    metaTitle: (appName) => `مجلة ${appName} — مقالات للعقول المثقلة`,
    metaDescription: "مقالات لطيفة عن العبء العاطفي، والراحة، وتدوين اليوميات، والوعي الذاتي. بدون حيل إنتاجية — فقط طرق ألطف لفهم ما تشعر به.",
    ogTitle: (appName) => `مجلة ${appName} — مقالات للعقول المثقلة`,
    ogDescription: "مقالات لطيفة عن العبء العاطفي، والراحة، والوعي الذاتي. بدون حيل إنتاجية.",
