...
export const uk: Translations = {
  ...
  upgradeFull: {
    ...
    pF3Sub: "Письмове дзеркало того, що Quiet Mirror помітив цього тижня",
    ...
    card4Text: "Цікавість і чесність зростають у нещодавніх записах — що часто сигналізує про те, що щось важливе стає яснішим.",
