...
f1Sub:"Відображайте кожен запис, не лише кілька на місяць",
f2Sub:"Дивіться, які теми та емоції продовжують спливати",
f3Sub:"Стислий дзеркальний звіт Quiet Mirror за тиждень",
f4Sub:"Розумійте повторювані цикли під вашими записами",
