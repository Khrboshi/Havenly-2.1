  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-emerald-300">Data ownership</h2>
        <p className="text-slate-300 text-sm leading-relaxed">
          All journal entries and personal reflections remain exclusively tied
          to your user account. They are not visible publicly and are never used
          to profile you or target you in any way.
        </p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <p className="text-slate-300 text-sm leading-relaxed">
          ...
          through Supabase. Access to your data requires authentication, and no
          one—including the Havenly team—can view or retrieve your journal
          entries.
        </p>
      </section>

      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-emerald-300">AI reflections</h2>
        <p className="text-slate-300 text-sm leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold text-emerald-300">Your control</h2>
        <p className="text-slate-300 text-sm leading-relaxed">
          You may delete your journal entries or your entire account at any
          time. Deleting your account removes all personal data permanently from
          our systems.
        </p>
      </section>
