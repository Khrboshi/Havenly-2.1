            ...
            <div className="mt-4 overflow-x-auto rounded-xl border border-white/10">
              <table className="w-full min-w-[480px] text-sm">
                <thead className="bg-white/5 text-qm-muted">
                  <tr>
                    <th className="text-left font-medium px-4 py-3">{locale === "ar" ? "التاريخ" : locale === "uk" ? "Дата" : t.settingsPage.emailLabel !== "Email" ? t.settingsPage.emailLabel !== "Email" ? t.settingsPage.emailLabel !== "Email" ? "Date" : "Date" : t.settingsPage.emailLabel !== "Email" ? "Date" : "Date" : t.settingsPage.emailLabel !== "Email" ? t.settingsPage.emailLabel !== "Email" ? "Date" : "Date" : t.settingsPage.emailLabel !== "Email" ? "Date" : "Date"}</th>
