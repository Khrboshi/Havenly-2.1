    ...
    <main className="min-h-screen bg-[#0B0F19] text-white px-6 pt-20 pb-32 max-w-4xl mx-auto">
      ...
      {role === "free" && (
        <div className="mb-6 text-sm text-[#8eeacb] bg-[#132225] border border-[#1d3a3d] rounded-md p-3">
          You’re on the free plan — daily journaling included.
          <br />
          <span className="text-gray-300">
            Soon you’ll unlock deeper weekly insights, emotion patterns, and clarity summaries.
          </span>
        </div>
      )}

      <h1 className="text-3xl font-semibold mb-3">
        Welcome back, <span className="text-[#54E1B3]">{user.email?.split("@")[0]}</span>
      </h1>
