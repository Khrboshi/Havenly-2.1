    ...
    <main className="min-h-screen bg-qm-bg text-qm-primary">
      ...
      <section id="terms-content" className="mx-auto max-w-4xl px-6 pb-16 pt-24">
        ...
        <p className="mt-3 max-w-2xl text-qm-secondary">
          These terms govern your use of <BrandName />. By creating an account or
          using the service, you agree to these terms. If you do not agree,
          please do not use <BrandName />.
        </p>
        ...
        <div className="mt-10 space-y-10 text-sm" role="article" aria-label="Terms of service details">
          ...
          <section id="what-quiet-mirror-is" aria-labelledby="what-quiet-mirror-is-heading">
            ...
            <p className="mt-2 text-qm-secondary">
              <BrandName /> is a private journaling and AI reflection companion. It is
          ...
          <section id="eligibility" aria-labelledby="eligibility-heading">
            ...
            <p className="mt-2 text-qm-secondary">
              You must be at least 16 years old to use <BrandName />. By creating an
          ...
          <section id="your-content" aria-labelledby="your-content-heading">
            ...
            <p className="mt-2 text-qm-secondary">
              ...
              in <BrandName />. By submitting content, you grant <BrandName /> a limited
          ...
          <section id="acceptable-use" aria-labelledby="acceptable-use-heading">
            ...
            <p className="mt-2 text-qm-secondary">You agree not to use <BrandName /> to:</p>
            <ul className="mt-3 list-disc space-y-2 ps-5 text-qm-secondary">
              <li>Violate any applicable law or regulation.</li>
              <li>Attempt to gain unauthorised access to <BrandName /> systems or other users&apos; data.</li>
              <li>Transmit malware, spam, or any content designed to disrupt the service.</li>
              <li>Use automated tools (bots, scrapers) to access or extract data from <BrandName /> without written permission.</li>
            </ul>
          ...
          <section id="payment" aria-labelledby="payment-heading">
            ...
            <p className="mt-2 text-qm-secondary">
              ...
              to {PAYMENT.providerName}&apos;s terms. <BrandName /> does not store your card details.
            </p>
          </section>
          ...
          <section id="ai-content" aria-labelledby="ai-content-heading">
            ...
            <p className="mt-2 text-qm-secondary">
              Reflections and insights generated by <BrandName /> are produced by AI
          ...
          <section id="privacy" aria-labelledby="privacy-heading">
            ...
            <p className="mt-2 text-qm-secondary">
              Your privacy is fundamental to <BrandName />. Please read our{" "}
              <Link
                href="/privacy"
          ...
          <section id="availability" aria-labelledby="availability-heading">
            ...
            <p className="mt-2 text-qm-secondary">
              We strive to keep <BrandName /> available and reliable, but we do not
          ...
          <section id="warranties" aria-labelledby="warranties-heading">
            ...
            <p className="mt-2 text-qm-secondary">
              <BrandName /> is provided &ldquo;as is&rdquo; and &ldquo;as
          ...
          <section id="changes" aria-labelledby="changes-heading">
            ...
            <p className="mt-2 text-qm-secondary">
              ...
              <BrandName /> after changes are posted constitutes acceptance of the
              updated terms.
            </p>
          </section>
