    ...
    <div className="min-h-screen bg-qm-bg text-qm-primary">
      ...
      <main className="relative mx-auto max-w-2xl px-6 pb-20 pt-24 sm:pt-32">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
          <Link
            href="/journal/new"
            className="inline-flex items-center justify-center rounded-full bg-[color:var(--hvn-accent-mint)] px-7 py-4 text-base font-semibold text-white shadow-lg transition-all hover:bg-[color:var(--hvn-accent-mint-hover)] hover:-translate-y-px sm:py-3.5 sm:text-sm"
          >
