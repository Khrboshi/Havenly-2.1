...
export const ARTICLES: BlogArticle[] = [
...

  {
    ...
    body: [
      ...
      "Writing a few sentences about what specifically you're dreading—not the whole week, but the one thing that's actually weighing on you—can interrupt the spiral. Havenly can help you see whether certain triggers keep coming back, whether the dread reliably connects to particular people, projects, or situations.",
  ...
  },
  {
    ...
    body: [
      ...
      "Journaling is one of the only places where the performance can come off—where you don't have to be the strong one for even a few sentences. Havenly notices when that exhaustion keeps appearing in your writing, when the weight of being relied on keeps surfacing underneath other topics.",
  ...
  },
  {
    ...
    body: [
      ...
      "Writing about good things, even briefly, starts to build a different habit. Havenly holds a record of the moments you named as meaningful, and over time that record can show you what actually matters to you—not just what you endure, but what you're quietly proud of and glad for.",
  ...
  },
  {
    ...
    body: [
      ...
      "The first step out of it isn't saying something more honest to other people—that can wait. It's saying something more honest to yourself, somewhere private. Havenly is built for that specific gap: the space between what you tell the room and what's actually going on.",
